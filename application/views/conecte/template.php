...
<body>
    ...
    <nav id="sidebar">
        <div id="newlog">
            ...
            <div class="title1">
                <img src="<?= base_url()?>assets/img/logo-Organize-branco.png">
            </div>
        </div>
            ...
            <div class="menu">
                <ul class="menu-links" style="position: relative;">
                    ...
                    <li class="<?php if (isset($menuNotaFiscal)) {
                        echo 'active';
                    }; ?>"><a class="tip-bottom" title="" href="<?php echo base_url() ?>index.php/mine/notaFiscal"><i class='bx bx-cart-alt iconX'></i> <span class="title">Nota Fiscal</span></a></li>
