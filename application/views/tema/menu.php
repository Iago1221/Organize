...
<nav id="sidebar">
    <div id="newlog">
        ...
        <div class="title1">
            <?= $configuration['app_theme'] == 'white' ||  $configuration['app_theme'] == 'whitegreen' ? '<img src="' . base_url() . 'assets/img/logo-Organize.png">' : '<img src="' . base_url() . 'assets/img/logo-Organize-branco.png">'; ?>
        </div>
    </div>
    ...
    <!-- Start Pesquisar-->
    <li class="search-box">
        <form style="display: flex" action="<?= site_url('Organize/pesquisar') ?>">
    ...
    <div class="menu-bar">
        <div class="menu">
            ...
            <ul class="menu-links" style="position: relative;">
                ...
                <?php if ($this->permission->checkPermission($this->session->userdata('permissao'), 'vVenda')) { ?>
                    <li class="<?php if (isset($menuNotaFiscal)) {
                        echo 'active';
                    }; ?>">
                        <a class="tip-bottom" title="" href="<?= site_url('notaFiscal') ?>"><i class='bx bx-tab iconX'></i></span>
                            <span class="title">Nota Fiscal</span>
                            <span class="title-tooltip">Nota Fiscal</span>
                        </a>
                    </li>
                <?php } ?>
