            ...
            <div class="widget-content nopadding tab-content">
                ...
                <form action="<?php echo current_url(); ?>" id="formProduto" method="post" class="form-horizontal">
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <input id="cfop" type="number" name="cfop" value="<?php echo $result->cfop; ?>" />
                        </div>
                    </div>
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <input id="ean" type="number" name="ean" value="<?php echo $result->ean; ?>" />
                        </div>
                    </div>
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <input id="ncm" type="number" name="ncm" value="<?php echo $result->ncm; ?>" />
                        </div>
                    </div>
