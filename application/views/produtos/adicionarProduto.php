            ...
            <div class="widget-content nopadding tab-content">
                ...
                <form action="<?php echo current_url(); ?>" id="formProduto" method="post" class="form-horizontal">
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <input id="cfop" type="number" name="cfop" value="<?php echo set_value('cfop'); ?>" />
                        </div>
                    </div>
                    <div class="control-group">
                        <label for="ean" class="control-label">EAN<span class="required">*</span></label>
                        <div class="controls">
                            <input id="ean" type="number" name="ean" value="<?php echo set_value('ean'); ?>" />
                        </div>
                    </div>
                    <div class="control-group">
                        <label for="ncm" class="control-label">NCM<span class="required">*</span></label>
                        <div class="controls">
                            <input id="ncm" type="number" name="ncm" value="<?php echo set_value('ncm'); ?>" />
                        </div>
                    </div>
                    <div class="control-group">
